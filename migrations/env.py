...
# 迁移目标固定来自 SQLAlchemy 模型（infrastructure/db/models.py），
# 不在这里另外维护一份 schema 定义。
target_metadata = Base.metadata

# 数据库连接串统一来自 Settings（REPOPILOT_POSTGRES_DSN），不在 alembic.ini
# 里硬编码，避免开发/测试/CI 环境需要分别改两个地方。
